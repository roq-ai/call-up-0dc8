...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'site_administrator.update': {
    roles: ['site-owner'],
    key: 'site-admin-accepted',
    tenantPath: ['company', 'user', 'site_administrator'],
    userPath: [],
  },
  'user.create': {
    roles: ['site-owner', 'site-administrator'],
    key: 'user-signed-up',
    tenantPath: ['company', 'user'],
    userPath: [],
  },
  'call_initiator.create': {
    roles: ['site-owner', 'site-administrator'],
    key: 'private-call-initiated',
    tenantPath: ['company', 'user', 'call_initiator'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['site-owner', 'site-administrator'];
