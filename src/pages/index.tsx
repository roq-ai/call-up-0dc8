  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Call Up - Your Gateway to Engaging, Private Conversations. Pay to connect, chat, share photos, and more with 18+ users. We value privacy, user-friendly interfaces, and fair revenue sharing."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1588873281272-14886ba1f737?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2aWRlbyUyMGNoYXR8ZW58MHx8fHwxNjk0NzU1ODc3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@dylanferreira?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Dylan Ferreira`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Call Up - Your Gateway to Engaging, Private Conversations. Pay to connect, chat, share photos, and more with 18+ users. We value privacy, user-friendly interfaces, and fair revenue sharing.`}
            </Text>
            <Box
